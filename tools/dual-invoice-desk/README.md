# Dual-chain USDC invoice desk

One invoice. **490 USDC**. Pay on **Solana** (Solana Pay URL + QR) or **Base** (copy card). Open `index.html` in a browser. Offline. No account.

## Invoice

| Field | Value |
|---|---|
| Invoice | **INV-20260826** |
...
Do not invent a third receive address. There is no Solana Pay `reference` keypair.
...
`solana:96BT6r5C35cvokdVop8ro4vDtv9zKUxpzrLbXqQbuHk3?amount=490&spl-token=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&memo=INV-20260826&label=Dual-chain%20USDC%20invoice`
